      ...
      >
        {editFormValues ? (
          <h4 style={{ textAlign: "center" }}>
            Location Name: {editFormValues?.formValues?.location_name}
          </h4>
        ) : null}
        <Form
          name="basic"
        ...
        >
          <div className="row" gutter={16}>
            <Col className="gutter-row input-field-bottom" span={16}>
              <Form.Item
                name="location_name"
                // rules={[
                //   {
              ...
              >
                <Input
                  name="location_name"
                  defaultValue={editFormValues?.formValues?.location_name}
              ...
              >
                <Input
                  name="address1"
                  defaultValue={editFormValues?.formValues?.address1}
                  onChange={handleChange}
              ...
              <Form.Item name="address2">
                <Input
                  ...
                  defaultValue={editFormValues?.formValues?.address2}
                />
              </Form.Item>
            </Col>
            <Col className="gutter-row input-bottom" span={8}>
              <Form.Item
                name="location_image"
                label={editFormValues ? "Uploaded File" : "Upload"}
                valuePropName="fileList"
                // getValueFromEvent={normFile}
              >
                {editFormValues ? (
                  <img
                    style={{ width: "30px", marginBottom: 5 }}
                    src={editFormValues.location_image}
                    alt={editFormValues.formValues.location_name}
                  />
                ) : null}
                <input type="file" onChange={normFile} accept="*" />
              </Form.Item>
            </Col>
            <Row gutter={[16, 24]}>
              <Col className="gutter-row" span={8}>
                ...
                >
                  <Select
                    ...
                    name="city"
                    defaultValue={editFormValues?.formValues?.city}
              ...
              <Col className="gutter-row" span={8}>
                ...
                >
                  <Select
                    ...
                    name="city"
                    defaultValue={editFormValues?.formValues?.state}
                  ...
                  >
                    ...
                    <Option value="California">Delaware</Option>
                    <Option value="California">Florida</Option>
                  </Select>
                </Form.Item>
              </Col>
              <Col className="gutter-row" span={8}>
                ...
                >
                  <Input
                    name="zip_code"
                    onChange={handleChange}
                    defaultValue={editFormValues?.formValues?.zip_code}
                    placeholder="ZipCode"
                  />
                </Form.Item>
              </Col>
            ...
            <Row gutter={[16, 24]}>
              <Col className="gutter-row" span={8}>
                <Form.Item label="Mailing Address Only" valuePropName="checked">
                  <Switch onChange={handleMail} name="is_mailingaddress_only" />
                </Form.Item>
              </Col>
              <Col className="gutter-row" span={8}>
                <Form.Item
              ...
              <Col className="gutter-row" span={8}>
                <Form.Item label="Virtual location " valuePropName="checked">
                  <Switch onChange={handleVirtual} name="is_virtual_location" />
                </Form.Item>
              </Col>
            </Row>
              ...
              <Col className="gutter-row" span={24}>
                <Tabs defaultActiveKey="1" onChange={callback}>
                  <TabPane tab="Contacts" key="1">
                    <Row gutter={[16, 24]}>
                      <Col className="gutter-row" span={24}>
                        <Form.Item name="isCopied" valuePropName="checked">
                          <Checkbox>
                            copy contacts from company profile
                          </Checkbox>
                        </Form.Item>
                      </Col>
                    </Row>
                    <Row gutter={[16, 24]}>
                      <Col className="gutter-row" span={12}>
                        <Form.Item name="phone">
                          <Input
                            onChange={handleChange}
                            defaultValue={editFormValues?.formValues?.phone}
                            name="phone"
                      ...
                      <Col className="gutter-row" span={12}>
                        <Input
                          onChange={handleChange}
                          defaultValue={editFormValues?.formValues?.email}
                          name="email"
