...
const EditLocationForm = ({ editRecordValues, sendChildToParent }) => {
    ...
    const formik = useFormik({
        initialValues: {
            name: editRecordValues.name,
            address_line1: editRecordValues.address_line1,
            address_line2: editRecordValues.address_line2,
            city: editRecordValues.zip_code.city,
            state: editRecordValues.zip_code.state,
            zip_code: editRecordValues.zip_code.zip_code,
            phone_id: editRecordValues.phone,
            email: editRecordValues.email,
            // logo_url: editRecordValues,
        },
